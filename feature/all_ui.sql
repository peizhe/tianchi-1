...
drop table if exists feature.train_ui_l1_buy;
create table feature.train_ui_l1_buy as
    ...
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l1_buy from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=4 and (event_date=30) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_l2_buy;
create table feature.train_ui_l2_buy as
    select user_id,item_id,ifnull(ui_l2_buy,0) as ui_l2_buy from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l2_buy from washed.tianchi_p_ten_buy_1_30 
...
drop table if exists feature.train_ui_l5_buy;
create table feature.train_ui_l5_buy as
    select user_id,item_id,ifnull(ui_l5_buy,0) as ui_l5_buy from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l5_buy from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=4 and (event_date between 26 and 30) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_l7_buy;
create table feature.train_ui_l7_buy as
    select user_id,item_id,ifnull(ui_l7_buy,0) as ui_l7_buy from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l7_buy from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=4 and (event_date between 26 and 30 or event_date between 22 and 23) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_l10_buy;
create table feature.train_ui_l10_buy as
    select user_id,item_id,ifnull(ui_l10_buy,0) as ui_l10_buy from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l10_buy from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=4 and (event_date between 26 and 30 or event_date between 19 and 23) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_l12_buy;
create table feature.train_ui_l12_buy as
    select user_id,item_id,ifnull(ui_l12_buy,0) as ui_l12_buy from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l12_buy from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=4 and (event_date between 26 and 30 or event_date between 17 and 23) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_l15_buy;
create table feature.train_ui_l15_buy as
    select user_id,item_id,ifnull(ui_l15_buy,0) as ui_l15_buy from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l15_buy from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=4 and (event_date between 26 and 30 or event_date between 14 and 23) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_l20_buy;
create table feature.train_ui_l20_buy as
    select user_id,item_id,ifnull(ui_l20_buy,0) as ui_l20_buy from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l20_buy from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=4 and (event_date between 26 and 30 or event_date between 9 and 23) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_l28_buy;
create table feature.train_ui_l28_buy as
    select user_id,item_id,ifnull(ui_l28_buy,0) as ui_l28_buy from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l28_buy from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=4 and (event_date between 26 and 30 or event_date between 1 and 23) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);



drop table if exists feature.train_ui_d12_buy;
create table feature.train_ui_d12_buy as
    select user_id,item_id,ifnull(ui_d12_buy,0) as ui_d12_buy from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_d12_buy from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=4 and (event_date between 24 and 25) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_week1_buy;
create table feature.train_ui_week1_buy as
    select user_id,item_id,ifnull(ui_week1_buy,0) as ui_week1_buy from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_week1_buy from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=4 and (event_date between 1 and 7) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_week2_buy;
create table feature.train_ui_week2_buy as
    select user_id,item_id,ifnull(ui_week2_buy,0) as ui_week2_buy from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_week2_buy from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=4 and (event_date between 8 and 14) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_week3_buy;
create table feature.train_ui_week3_buy as
    select user_id,item_id,ifnull(ui_week3_buy,0) as ui_week3_buy from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_week3_buy from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=4 and (event_date between 15 and 21) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_25_27_buy;
create table feature.train_ui_25_27_buy as
    select user_id,item_id,ifnull(ui_25_27_buy,0) as ui_25_27_buy from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_25_27_buy from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=4 and (event_date between 25 and 27) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_22_24_buy;
create table feature.train_ui_22_24_buy as
    select user_id,item_id,ifnull(ui_22_24_buy,0) as ui_22_24_buy from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_22_24_buy from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=4 and (event_date between 22 and 24) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_19_21_buy;
create table feature.train_ui_19_21_buy as
    select user_id,item_id,ifnull(ui_19_21_buy,0) as ui_19_21_buy from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_19_21_buy from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=4 and (event_date between 19 and 21) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_16_18_buy;
create table feature.train_ui_16_18_buy as
    select user_id,item_id,ifnull(ui_16_18_buy,0) as ui_16_18_buy from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_16_18_buy from washed.tianchi_p_ten_buy_1_30 
...
drop table if exists feature.train_ui_l1_clk;
create table feature.train_ui_l1_clk as
    select user_id,item_id,ifnull(ui_l1_clk,0) as ui_l1_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l1_clk from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=1 and (event_date=30) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_l2_clk;
create table feature.train_ui_l2_clk as
    select user_id,item_id,ifnull(ui_l2_clk,0) as ui_l2_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l2_clk from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=1 and (event_date between 29 and 30) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_l3_clk;
create table feature.train_ui_l3_clk as
    select user_id,item_id,ifnull(ui_l3_clk,0) as ui_l3_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l3_clk from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=1 and (event_date between 28 and 30) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_l5_clk;
create table feature.train_ui_l5_clk as
    select user_id,item_id,ifnull(ui_l5_clk,0) as ui_l5_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l5_clk from washed.tianchi_p_ten_buy_1_30 
...
drop table if exists feature.train_ui_l10_clk;
create table feature.train_ui_l10_clk as
    select user_id,item_id,ifnull(ui_l10_clk,0) as ui_l10_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l10_clk from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=1 and (event_date between 26 and 30 or event_date between 19 and 23) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_l12_clk;
create table feature.train_ui_l12_clk as
    select user_id,item_id,ifnull(ui_l12_clk,0) as ui_l12_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l12_clk from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=1 and (event_date between 26 and 30 or event_date between 17 and 23) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_l15_clk;
create table feature.train_ui_l15_clk as
    select user_id,item_id,ifnull(ui_l15_clk,0) as ui_l15_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l15_clk from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=1 and (event_date between 26 and 30 or event_date between 14 and 23) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_l20_clk;
create table feature.train_ui_l20_clk as
    select user_id,item_id,ifnull(ui_l20_clk,0) as ui_l20_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l20_clk from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=1 and (event_date between 26 and 30 or event_date between 9 and 23) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_l28_clk;
create table feature.train_ui_l28_clk as
    select user_id,item_id,ifnull(ui_l28_clk,0) as ui_l28_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l28_clk from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=1 and (event_date between 26 and 30 or event_date between 1 and 23) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);
...
drop table if exists feature.train_ui_week1_clk;
create table feature.train_ui_week1_clk as
    select user_id,item_id,ifnull(ui_week1_clk,0) as ui_week1_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_week1_clk from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=1 and (event_date between 1 and 7) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_week2_clk;
create table feature.train_ui_week2_clk as
    select user_id,item_id,ifnull(ui_week2_clk,0) as ui_week2_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_week2_clk from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=1 and (event_date between 8 and 14) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_week3_clk;
create table feature.train_ui_week3_clk as
    select user_id,item_id,ifnull(ui_week3_clk,0) as ui_week3_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_week3_clk from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=1 and (event_date between 15 and 21) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_25_27_clk;
create table feature.train_ui_25_27_clk as
    select user_id,item_id,ifnull(ui_25_27_clk,0) as ui_25_27_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_25_27_clk from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=1 and (event_date between 25 and 27) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_22_24_clk;
create table feature.train_ui_22_24_clk as
    select user_id,item_id,ifnull(ui_22_24_clk,0) as ui_22_24_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_22_24_clk from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=1 and (event_date between 22 and 24) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_19_21_clk;
create table feature.train_ui_19_21_clk as
    select user_id,item_id,ifnull(ui_19_21_clk,0) as ui_19_21_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_19_21_clk from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=1 and (event_date between 19 and 21) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_16_18_clk;
create table feature.train_ui_16_18_clk as
    select user_id,item_id,ifnull(ui_16_18_clk,0) as ui_16_18_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_16_18_clk from washed.tianchi_p_ten_buy_1_30 
...
drop table if exists feature.train_ui_l1_act;
create table feature.train_ui_l1_act as
    select user_id,item_id,ifnull(ui_l1_act,0) as ui_l1_act from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l1_act from washed.tianchi_p_ten_buy_1_30 
    where (event_date=30) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_l2_act;
create table feature.train_ui_l2_act as
    select user_id,item_id,ifnull(ui_l2_act,0) as ui_l2_act from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l2_act from washed.tianchi_p_ten_buy_1_30 
    where (event_date between 29 and 30) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_l3_act;
create table feature.train_ui_l3_act as
    select user_id,item_id,ifnull(ui_l3_act,0) as ui_l3_act from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l3_act from washed.tianchi_p_ten_buy_1_30 
    where (event_date between 28 and 30) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_l5_act;
create table feature.train_ui_l5_act as
    select user_id,item_id,ifnull(ui_l5_act,0) as ui_l5_act from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l5_act from washed.tianchi_p_ten_buy_1_30 
    where (event_date between 26 and 30) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_l7_act;
create table feature.train_ui_l7_act as
    select user_id,item_id,ifnull(ui_l7_act,0) as ui_l7_act from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l7_act from washed.tianchi_p_ten_buy_1_30 
    where (event_date between 26 and 30 or event_date between 22 and 23) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);
...
drop table if exists feature.train_ui_l12_act;
create table feature.train_ui_l12_act as
    select user_id,item_id,ifnull(ui_l12_act,0) as ui_l12_act from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l12_act from washed.tianchi_p_ten_buy_1_30 
    where (event_date between 26 and 30 or event_date between 17 and 23) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_l15_act;
create table feature.train_ui_l15_act as
    select user_id,item_id,ifnull(ui_l15_act,0) as ui_l15_act from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l15_act from washed.tianchi_p_ten_buy_1_30 
    where (event_date between 26 and 30 or event_date between 14 and 23) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_l20_act;
create table feature.train_ui_l20_act as
    select user_id,item_id,ifnull(ui_l20_act,0) as ui_l20_act from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l20_act from washed.tianchi_p_ten_buy_1_30 
    where (event_date between 26 and 30 or event_date between 9 and 23) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_l28_act;
create table feature.train_ui_l28_act as
    select user_id,item_id,ifnull(ui_l28_act,0) as ui_l28_act from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l28_act from washed.tianchi_p_ten_buy_1_30 
    where (event_date between 26 and 30 or event_date between 1 and 23) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);



drop table if exists feature.train_ui_d12_act;
create table feature.train_ui_d12_act as
    select user_id,item_id,ifnull(ui_d12_act,0) as ui_d12_act from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_d12_act from washed.tianchi_p_ten_buy_1_30 
    where (event_date between 24 and 25) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_week1_act;
create table feature.train_ui_week1_act as
    select user_id,item_id,ifnull(ui_week1_act,0) as ui_week1_act from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_week1_act from washed.tianchi_p_ten_buy_1_30 
    where (event_date between 1 and 7) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_week2_act;
create table feature.train_ui_week2_act as
    select user_id,item_id,ifnull(ui_week2_act,0) as ui_week2_act from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_week2_act from washed.tianchi_p_ten_buy_1_30 
    where (event_date between 8 and 14) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_week3_act;
create table feature.train_ui_week3_act as
    select user_id,item_id,ifnull(ui_week3_act,0) as ui_week3_act from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_week3_act from washed.tianchi_p_ten_buy_1_30 
    where (event_date between 15 and 21) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_25_27_act;
create table feature.train_ui_25_27_act as
    select user_id,item_id,ifnull(ui_25_27_act,0) as ui_25_27_act from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_25_27_act from washed.tianchi_p_ten_buy_1_30 
    where (event_date between 25 and 27) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_22_24_act;
create table feature.train_ui_22_24_act as
    select user_id,item_id,ifnull(ui_22_24_act,0) as ui_22_24_act from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_22_24_act from washed.tianchi_p_ten_buy_1_30 
    where (event_date between 22 and 24) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_19_21_act;
create table feature.train_ui_19_21_act as
    select user_id,item_id,ifnull(ui_19_21_act,0) as ui_19_21_act from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_19_21_act from washed.tianchi_p_ten_buy_1_30 
    where (event_date between 19 and 21) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_16_18_act;
create table feature.train_ui_16_18_act as
    select user_id,item_id,ifnull(ui_16_18_act,0) as ui_16_18_act from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_16_18_act from washed.tianchi_p_ten_buy_1_30 
...
drop table if exists feature.train_ui_l1_later;
create table feature.train_ui_l1_later as
    select user_id,item_id,ifnull(ui_l1_later,0) as ui_l1_later from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l1_later from washed.tianchi_p_ten_buy_1_30 
    where (behavior_type between 2 and 3) and (event_date=30) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_l2_later;
create table feature.train_ui_l2_later as
    select user_id,item_id,ifnull(ui_l2_later,0) as ui_l2_later from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l2_later from washed.tianchi_p_ten_buy_1_30 
    where (behavior_type between 2 and 3) and (event_date between 29 and 30) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_l3_later;
create table feature.train_ui_l3_later as
    select user_id,item_id,ifnull(ui_l3_later,0) as ui_l3_later from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l3_later from washed.tianchi_p_ten_buy_1_30 
    where (behavior_type between 2 and 3) and (event_date between 28 and 30) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_l5_later;
create table feature.train_ui_l5_later as
    select user_id,item_id,ifnull(ui_l5_later,0) as ui_l5_later from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l5_later from washed.tianchi_p_ten_buy_1_30 
    where (behavior_type between 2 and 3) and (event_date between 26 and 30) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_l7_later;
create table feature.train_ui_l7_later as
    select user_id,item_id,ifnull(ui_l7_later,0) as ui_l7_later from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l7_later from washed.tianchi_p_ten_buy_1_30 
...
drop table if exists feature.train_ui_l12_later;
create table feature.train_ui_l12_later as
    select user_id,item_id,ifnull(ui_l12_later,0) as ui_l12_later from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l12_later from washed.tianchi_p_ten_buy_1_30 
    where (behavior_type between 2 and 3) and (event_date between 26 and 30 or event_date between 17 and 23) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_l15_later;
create table feature.train_ui_l15_later as
    select user_id,item_id,ifnull(ui_l15_later,0) as ui_l15_later from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l15_later from washed.tianchi_p_ten_buy_1_30 
    where (behavior_type between 2 and 3) and (event_date between 26 and 30 or event_date between 14 and 23) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_l20_later;
create table feature.train_ui_l20_later as
    select user_id,item_id,ifnull(ui_l20_later,0) as ui_l20_later from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l20_later from washed.tianchi_p_ten_buy_1_30 
    where (behavior_type between 2 and 3) and (event_date between 26 and 30 or event_date between 9 and 23) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_l28_later;
create table feature.train_ui_l28_later as
    select user_id,item_id,ifnull(ui_l28_later,0) as ui_l28_later from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_l28_later from washed.tianchi_p_ten_buy_1_30 
    where (behavior_type between 2 and 3) and (event_date between 26 and 30 or event_date between 1 and 23) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_week1_later;
create table feature.train_ui_week1_later as
    select user_id,item_id,ifnull(ui_week1_later,0) as ui_week1_later from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_week1_later from washed.tianchi_p_ten_buy_1_30 
    where (behavior_type between 2 and 3) and (event_date between 1 and 7) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_week2_later;
create table feature.train_ui_week2_later as
    select user_id,item_id,ifnull(ui_week2_later,0) as ui_week2_later from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_week2_later from washed.tianchi_p_ten_buy_1_30 
    where (behavior_type between 2 and 3) and (event_date between 8 and 14) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_week3_later;
create table feature.train_ui_week3_later as
    select user_id,item_id,ifnull(ui_week3_later,0) as ui_week3_later from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1, item_id as item_id_1, count(behavior_type) as ui_week3_later from washed.tianchi_p_ten_buy_1_30 
...
drop table if exists feature.train_ui_f_actday_favor;
create table feature.train_ui_f_actday_favor as
...
drop table if exists feature.train_ui_f_actday_buy;
create table feature.train_ui_f_actday_buy as
...
drop table if exists feature.train_ui_l_actday_favor;
create table feature.train_ui_l_actday_favor as
...
drop table if exists feature.train_ui_l_actday_buy;
create table feature.train_ui_l_actday_buy as
...
drop table if exists feature.train_ui_l3_h1_buy;
create table feature.train_ui_l3_h1_buy as
...
drop table if exists feature.train_ui_l5_h1_buy;
create table feature.train_ui_l5_h1_buy as
...
drop table if exists feature.train_ui_l14_h1_buy;
create table feature.train_ui_l14_h1_buy as
    ...
    (
        ...
        (select distinct user_id,item_id,event_date from washed.tianchi_p_ten_buy_1_30 where 
            (event_date between 26 and 30 or event_date between 15 and 23) and behavior_type=4
            )b
        group by user_id,item_id
    )c
    on (a.user_id=c.user_id_1 and a.item_id=c.item_id_1);
...
drop table if exists feature.train_ui_f14_h1_buy;
create table feature.train_ui_f14_h1_buy as
...
drop table if exists feature.train_ui_l3_h1_act;
create table feature.train_ui_l3_h1_act as
...
drop table if exists feature.train_ui_l5_h1_act;
create table feature.train_ui_l5_h1_act as
...
drop table if exists feature.train_ui_l7_h1_act;
create table feature.train_ui_l7_h1_act as
...
create table feature.train_ui_l14_h1_act as
    ...
    (
        ...
        (select distinct user_id,item_id,event_date from washed.tianchi_p_ten_buy_1_30 where 
            (event_date between 26 and 30 or event_date between 15 and 23)
            )b
        group by user_id,item_id
    )c
    on (a.user_id=c.user_id_1 and a.item_id=c.item_id_1);
...
drop table if exists feature.train_ui_f14_h1_act;
create table feature.train_ui_f14_h1_act as
...
drop table if exists feature.train_ui_l1_day_act;
create table feature.train_ui_l1_day_act as
    select user_id,item_id,ifnull(ui_l1_day_act,0) as ui_l1_day_act from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l1_day_act from washed.tianchi_p_ten_buy_1_30 
...
drop table if exists feature.train_ui_l5_day_act;
create table feature.train_ui_l5_day_act as
    select user_id,item_id,ifnull(ui_l5_day_act,0) as ui_l5_day_act from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l5_day_act from washed.tianchi_p_ten_buy_1_30 
    where (event_date between 26 and 30) and (event_time between 8 and 18) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_l7_day_act;
create table feature.train_ui_l7_day_act as
    select user_id,item_id,ifnull(ui_l7_day_act,0) as ui_l7_day_act from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l7_day_act from washed.tianchi_p_ten_buy_1_30 
    where (event_date between 26 and 30 or event_date between 22 and 23) and (event_time between 8 and 18) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

/*用户在最近 1、3、5、7 天的白天点击此商品的次数*/

drop table if exists feature.train_ui_l1_day_clk;
create table feature.train_ui_l1_day_clk as
    select user_id,item_id,ifnull(ui_l1_day_clk,0) as ui_l1_day_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l1_day_clk from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=1 and (event_date=30) and (event_time between 8 and 18) 
    group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_l3_day_clk;
create table feature.train_ui_l3_day_clk as
    select user_id,item_id,ifnull(ui_l3_day_clk,0) as ui_l3_day_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l3_day_clk from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=1 and (event_date between 28 and 30) and (event_time between 8 and 18) 
    group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_l5_day_clk;
create table feature.train_ui_l5_day_clk as
    select user_id,item_id,ifnull(ui_l5_day_clk,0) as ui_l5_day_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l5_day_clk from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=1 and (event_date between 26 and 30) and (event_time between 8 and 18) 
    group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_l7_day_clk;
create table feature.train_ui_l7_day_clk as
    select user_id,item_id,ifnull(ui_l7_day_clk,0) as ui_l7_day_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l7_day_clk from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=1 and (event_date between 26 and 30 or event_date between 22 and 23) and (event_time between 8 and 18) 
    group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);
...
drop table if exists feature.train_ui_l1_day_buy;
create table feature.train_ui_l1_day_buy as
    select user_id,item_id,ifnull(ui_l1_day_buy,0) as ui_l1_day_buy from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l1_day_buy from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=4 and (event_date=30) and (event_time between 8 and 18) 
    group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_l3_day_buy;
create table feature.train_ui_l3_day_buy as
    select user_id,item_id,ifnull(ui_l3_day_buy,0) as ui_l3_day_buy from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l3_day_buy from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=4 and (event_date between 28 and 30) and (event_time between 8 and 18) 
    group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_l5_day_buy;
create table feature.train_ui_l5_day_buy as
    select user_id,item_id,ifnull(ui_l5_day_buy,0) as ui_l5_day_buy from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l5_day_buy from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=4 and (event_date between 26 and 30) and (event_time between 8 and 18) 
    group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_l7_day_buy;
create table feature.train_ui_l7_day_buy as
    select user_id,item_id,ifnull(ui_l7_day_buy,0) as ui_l7_day_buy from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l7_day_buy from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=4 and (event_date between 26 and 30 or event_date between 22 and 23) and (event_time between 8 and 18) 
    group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);
...
drop table if exists feature.train_ui_l1_eve_act;
create table feature.train_ui_l1_eve_act as
    select user_id,item_id,ifnull(ui_l1_eve_act,0) as ui_l1_eve_act from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l1_eve_act from washed.tianchi_p_ten_buy_1_30 
    where (event_date=30) and (event_time between 19 and 23 or event_time between 0 and 1) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_l3_eve_act;
create table feature.train_ui_l3_eve_act as
    select user_id,item_id,ifnull(ui_l3_eve_act,0) as ui_l3_eve_act from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l3_eve_act from washed.tianchi_p_ten_buy_1_30 
...
drop table if exists feature.train_ui_l5_eve_act;
create table feature.train_ui_l5_eve_act as
    select user_id,item_id,ifnull(ui_l5_eve_act,0) as ui_l5_eve_act from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l5_eve_act from washed.tianchi_p_ten_buy_1_30 
...
drop table if exists feature.train_ui_l7_eve_act;
create table feature.train_ui_l7_eve_act as
    select user_id,item_id,ifnull(ui_l7_eve_act,0) as ui_l7_eve_act from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l7_eve_act from washed.tianchi_p_ten_buy_1_30 
    where (event_date between 26 and 30 or event_date between 22 and 23) and (event_time between 19 and 23 or event_time between 0 and 1) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_l1_eve_clk;
create table feature.train_ui_l1_eve_clk as
    select user_id,item_id,ifnull(ui_l1_eve_clk,0) as ui_l1_eve_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l1_eve_clk from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=1 and (event_date=30) and (event_time between 19 and 23 or event_time between 0 and 1) 
    group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_l3_eve_clk;
create table feature.train_ui_l3_eve_clk as
    select user_id,item_id,ifnull(ui_l3_eve_clk,0) as ui_l3_eve_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l3_eve_clk from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=1 and (event_date between 28 and 30) and (event_time between 19 and 23 or event_time between 0 and 1) 
    group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_l5_eve_clk;
create table feature.train_ui_l5_eve_clk as
    select user_id,item_id,ifnull(ui_l5_eve_clk,0) as ui_l5_eve_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l5_eve_clk from washed.tianchi_p_ten_buy_1_30 
...
drop table if exists feature.train_ui_l1_eve_buy;
create table feature.train_ui_l1_eve_buy as
    select user_id,item_id,ifnull(ui_l1_eve_buy,0) as ui_l1_eve_buy from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l1_eve_buy from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=4 and (event_date=30) and (event_time between 19 and 23 or event_time between 0 and 1) 
    group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_l3_eve_buy;
create table feature.train_ui_l3_eve_buy as
    select user_id,item_id,ifnull(ui_l3_eve_buy,0) as ui_l3_eve_buy from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l3_eve_buy from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=4 and (event_date between 28 and 30) and (event_time between 19 and 23 or event_time between 0 and 1) 
    group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_l5_eve_buy;
create table feature.train_ui_l5_eve_buy as
    select user_id,item_id,ifnull(ui_l5_eve_buy,0) as ui_l5_eve_buy from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l5_eve_buy from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=4 and (event_date between 26 and 30) and (event_time between 19 and 23 or event_time between 0 and 1) 
    group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_l7_eve_buy;
create table feature.train_ui_l7_eve_buy as
    select user_id,item_id,ifnull(ui_l7_eve_buy,0) as ui_l7_eve_buy from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l7_eve_buy from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=4 and (event_date between 26 and 30 or event_date between 22 and 23) and (event_time between 19 and 23 or event_time between 0 and 1) 
    group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);
...
drop table if exists feature.train_ui_l1_nt_act;
create table feature.train_ui_l1_nt_act as
    select user_id,item_id,ifnull(ui_l1_nt_act,0) as ui_l1_nt_act from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l1_nt_act from washed.tianchi_p_ten_buy_1_30 
    where (event_date=30) and (event_time between 2 and 7) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_l3_nt_act;
create table feature.train_ui_l3_nt_act as
    select user_id,item_id,ifnull(ui_l3_nt_act,0) as ui_l3_nt_act from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l3_nt_act from washed.tianchi_p_ten_buy_1_30 
    where (event_date between 28 and 30) and (event_time between 2 and 7) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_l5_nt_act;
create table feature.train_ui_l5_nt_act as
    select user_id,item_id,ifnull(ui_l5_nt_act,0) as ui_l5_nt_act from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l5_nt_act from washed.tianchi_p_ten_buy_1_30 
    where (event_date between 26 and 30) and (event_time between 2 and 7) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_l7_nt_act;
create table feature.train_ui_l7_nt_act as
    select user_id,item_id,ifnull(ui_l7_nt_act,0) as ui_l7_nt_act from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l7_nt_act from washed.tianchi_p_ten_buy_1_30 
    where (event_date between 26 and 30 or event_date between 22 and 23) and (event_time between 2 and 7) group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_l1_nt_clk;
create table feature.train_ui_l1_nt_clk as
    select user_id,item_id,ifnull(ui_l1_nt_clk,0) as ui_l1_nt_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l1_nt_clk from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=1 and (event_date=30) and (event_time between 2 and 7) 
    group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_l3_nt_clk;
create table feature.train_ui_l3_nt_clk as
    select user_id,item_id,ifnull(ui_l3_nt_clk,0) as ui_l3_nt_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l3_nt_clk from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=1 and (event_date between 28 and 30) and (event_time between 2 and 7) 
    group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_l5_nt_clk;
create table feature.train_ui_l5_nt_clk as
    select user_id,item_id,ifnull(ui_l5_nt_clk,0) as ui_l5_nt_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l5_nt_clk from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=1 and (event_date between 26 and 30) and (event_time between 2 and 7) 
    group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_l7_nt_clk;
create table feature.train_ui_l7_nt_clk as
    select user_id,item_id,ifnull(ui_l7_nt_clk,0) as ui_l7_nt_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l7_nt_clk from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=1 and (event_date between 26 and 30 or event_date between 22 and 23) and (event_time between 2 and 7) 
    group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_l1_nt_buy;
create table feature.train_ui_l1_nt_buy as
    select user_id,item_id,ifnull(ui_l1_nt_buy,0) as ui_l1_nt_buy from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l1_nt_buy from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=4 and (event_date=30) and (event_time between 2 and 7) 
    group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_l3_nt_buy;
create table feature.train_ui_l3_nt_buy as
    select user_id,item_id,ifnull(ui_l3_nt_buy,0) as ui_l3_nt_buy from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l3_nt_buy from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=4 and (event_date between 28 and 30) and (event_time between 2 and 7) 
    group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);

drop table if exists feature.train_ui_l5_nt_buy;
create table feature.train_ui_l5_nt_buy as
    select user_id,item_id,ifnull(ui_l5_nt_buy,0) as ui_l5_nt_buy from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l5_nt_buy from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=4 and (event_date between 26 and 30) and (event_time between 2 and 7) 
    group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_l7_nt_buy;
create table feature.train_ui_l7_nt_buy as
    select user_id,item_id,ifnull(ui_l7_nt_buy,0) as ui_l7_nt_buy from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1, count(behavior_type) as ui_l7_nt_buy from washed.tianchi_p_ten_buy_1_30 
    where behavior_type=4 and (event_date between 26 and 30 or event_date between 22 and 23) and (event_time between 2 and 7) 
    group by user_id,item_id)b
    on (a.user_id=b.user_id_1 and a.item_id=b.item_id_1);
...
drop table if exists feature.train_ui_1_30_later;
create table feature.train_ui_1_30_later as
    select user_id,item_id,ifnull(ui_1_30_later,0) as ui_1_30_later from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1,count(behavior_type) as ui_1_30_later from washed.tianchi_p_ten_buy_1_30 
...
drop table if exists feature.train_ui_l14_later;
create table feature.train_ui_l14_later as
    select user_id,item_id,ifnull(ui_l14_later,0) as ui_l14_later from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1,count(behavior_type) as ui_l14_later from washed.tianchi_p_ten_buy_1_30 
        where behavior_type between 2 and 3 and (event_date between 26 and 30 or event_date between 15 and 23)
        group by user_id,item_id)b
    on(a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_l14_clk;
create table feature.train_ui_l14_clk as
    select user_id,item_id,ifnull(ui_l14_clk,0) as ui_l14_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1,count(behavior_type) as ui_l14_clk from washed.tianchi_p_ten_buy_1_30 
        where behavior_type=1 and (event_date between 26 and 30 or event_date between 15 and 23)
        group by user_id,item_id)b
    on(a.user_id=b.user_id_1 and a.item_id=b.item_id_1);


drop table if exists feature.train_ui_l14_buy;
create table feature.train_ui_l14_buy as
    select user_id,item_id,ifnull(ui_l14_buy,0) as ui_l14_buy from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1,count(behavior_type) as ui_l14_buy from washed.tianchi_p_ten_buy_1_30 
        where behavior_type=4 and (event_date between 26 and 30 or event_date between 15 and 23)
        group by user_id,item_id)b
    on(a.user_id=b.user_id_1 and a.item_id=b.item_id_1);
...
create table feature.train_ui_1_30_clk2buy as
    ...
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1,ui_1_30_clk from feature.train_ui_1_30_clk)b
    on(a.user_id=b.user_id_1 and a.item_id=b.item_id_1)
    )c
    left outer join
    (select user_id as user_id_2,item_id as item_id_2,ui_1_30_buy from feature.train_ui_1_30_buy)d
    on(c.user_id=d.user_id_2 and c.item_id=d.item_id_2);


drop table if exists feature.train_ui_1_30_clk2later;
create table feature.train_ui_1_30_clk2later as
    ...
    left outer join
    (select user_id as user_id_2,item_id as item_id_2,ui_1_30_later from feature.train_ui_1_30_later)d
    on(c.user_id=d.user_id_2 and c.item_id=d.item_id_2);


drop table if exists feature.train_ui_1_30_later2buy;
create table feature.train_ui_1_30_later2buy as
    ...
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1,ui_1_30_later from feature.train_ui_1_30_later)b
    on(a.user_id=b.user_id_1 and a.item_id=b.item_id_1)
    )c
    left outer join
    (select user_id as user_id_2,item_id as item_id_2,ui_1_30_buy from feature.train_ui_1_30_buy)d
...
drop table if exists feature.train_ui_d12_clk2buy;
create table feature.train_ui_d12_clk2buy as
    ...
    left outer join
    (select user_id as user_id_2,item_id as item_id_2,ui_d12_buy from feature.train_ui_d12_buy)d
    on(c.user_id=d.user_id_2 and c.item_id=d.item_id_2);
...
drop table if exists feature.train_ui_d12_later2buy;
create table feature.train_ui_d12_later2buy as
    select user_id,item_id,ifnull(ui_d12_later/ui_d12_buy,0) as ui_d12_later2buy from
    (
    select user_id,item_id,ui_d12_later from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1,ui_d12_later from feature.train_ui_d12_later)b
    on(a.user_id=b.user_id_1 and a.item_id=b.item_id_1)
    )c
    left outer join
    (select user_id as user_id_2,item_id as item_id_2,ui_d12_buy from feature.train_ui_d12_buy)d
...
drop table if exists feature.train_ui_l28_clk2buy;
create table feature.train_ui_l28_clk2buy as
    select user_id,item_id,ifnull(ui_l28_clk/ui_l28_buy,0) as ui_l28_clk2buy from
    (
    select user_id,item_id,ui_l28_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1,ui_l28_clk from feature.train_ui_l28_clk)b
    on(a.user_id=b.user_id_1 and a.item_id=b.item_id_1)
    )c
    left outer join
    (select user_id as user_id_2,item_id as item_id_2,ui_l28_buy from feature.train_ui_l28_buy)d
    on(c.user_id=d.user_id_2 and c.item_id=d.item_id_2);


drop table if exists feature.train_ui_l28_clk2later;
create table feature.train_ui_l28_clk2later as
    ...
    left outer join
    (select user_id as user_id_2,item_id as item_id_2,ui_l28_later from feature.train_ui_l28_later)d
    on(c.user_id=d.user_id_2 and c.item_id=d.item_id_2);


drop table if exists feature.train_ui_l28_later2buy;
create table feature.train_ui_l28_later2buy as
    select user_id,item_id,ifnull(ui_l28_later/ui_l28_buy,0) as ui_l28_later2buy from
    (
    select user_id,item_id,ui_l28_later from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1,ui_l28_later from feature.train_ui_l28_later)b
    on(a.user_id=b.user_id_1 and a.item_id=b.item_id_1)
    )c
    left outer join
    (select user_id as user_id_2,item_id as item_id_2,ui_l28_buy from feature.train_ui_l28_buy)d
...
drop table if exists feature.train_ui_l14_clk2buy;
create table feature.train_ui_l14_clk2buy as
    select user_id,item_id,ifnull(ui_l14_clk/ui_l14_buy,0) as ui_l14_clk2buy from
    (
    select user_id,item_id,ui_l14_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1,ui_l14_clk from feature.train_ui_l14_clk)b
    on(a.user_id=b.user_id_1 and a.item_id=b.item_id_1)
    )c
    left outer join
    (select user_id as user_id_2,item_id as item_id_2,ui_l14_buy from feature.train_ui_l14_buy)d
    on(c.user_id=d.user_id_2 and c.item_id=d.item_id_2);


drop table if exists feature.train_ui_l14_clk2later;
create table feature.train_ui_l14_clk2later as
    ...
    left outer join
    (select user_id as user_id_2,item_id as item_id_2,ui_l14_later from feature.train_ui_l14_later)d
    on(c.user_id=d.user_id_2 and c.item_id=d.item_id_2);


drop table if exists feature.train_ui_l14_later2buy;
create table feature.train_ui_l14_later2buy as
    select user_id,item_id,ifnull(ui_l14_later/ui_l14_buy,0) as ui_l14_later2buy from
    (
    select user_id,item_id,ui_l14_later from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1,ui_l14_later from feature.train_ui_l14_later)b
    on(a.user_id=b.user_id_1 and a.item_id=b.item_id_1)
    )c
    left outer join
    (select user_id as user_id_2,item_id as item_id_2,ui_l14_buy from feature.train_ui_l14_buy)d
...
drop table if exists feature.train_ui_l7_clk2buy;
create table feature.train_ui_l7_clk2buy as
    select user_id,item_id,ifnull(ui_l7_clk/ui_l7_buy,0) as ui_l7_clk2buy from
    (
    select user_id,item_id,ui_l7_clk from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1,ui_l7_clk from feature.train_ui_l7_clk)b
    on(a.user_id=b.user_id_1 and a.item_id=b.item_id_1)
    )c
    left outer join
    (select user_id as user_id_2,item_id as item_id_2,ui_l7_buy from feature.train_ui_l7_buy)d
    on(c.user_id=d.user_id_2 and c.item_id=d.item_id_2);


drop table if exists feature.train_ui_l7_clk2later;
create table feature.train_ui_l7_clk2later as
    ...
    left outer join
    (select user_id as user_id_2,item_id as item_id_2,ui_l7_later from feature.train_ui_l7_later)d
    on(c.user_id=d.user_id_2 and c.item_id=d.item_id_2);


drop table if exists feature.train_ui_l7_later2buy;
create table feature.train_ui_l7_later2buy as
    select user_id,item_id,ifnull(ui_l7_later/ui_l7_buy,0) as ui_l7_later2buy from
    (
    select user_id,item_id,ui_l7_later from
    (select distinct user_id,item_id from washed.tianchi_p_ten_buy_1_30)a
    left outer join
    (select user_id as user_id_1,item_id as item_id_1,ui_l7_later from feature.train_ui_l7_later)b
    on(a.user_id=b.user_id_1 and a.item_id=b.item_id_1)
    )c
    left outer join
    (select user_id as user_id_2,item_id as item_id_2,ui_l7_buy from feature.train_ui_l7_buy)d
...
drop table if exists feature.train_ui_l3_h1_only_act;
create table feature.train_ui_l3_h1_only_act as
...
drop table if exists feature.train_ui_l5_h1_only_act;
create table feature.train_ui_l5_h1_only_act as
...
drop table if exists feature.train_ui_l10_h1_only_act;
create table feature.train_ui_l10_h1_only_act as
    ...
    (select distinct user_id,item_id,event_date from washed.tianchi_p_ten_buy_1_30
    where event_date between 26 and 30 or event_date between 19 and 23 
    order by user_id,event_date)aa
    ...
    select user_id,event_date,count(distinct item_id) as user_distinct_act from
    (select distinct user_id,item_id,event_date from washed.tianchi_p_ten_buy_1_30
        where event_date between 26 and 30 or event_date between 19 and 23)a
    group by user_id,event_date
    )b
    where user_distinct_act=1 
    order by user_id,event_date
...
drop table if exists feature.train_ui_l14_h1_only_act;
create table feature.train_ui_l14_h1_only_act as
    ...
    (select distinct user_id,item_id,event_date from washed.tianchi_p_ten_buy_1_30
    where event_date between 26 and 30 or event_date between 15 and 23 
    order by user_id,event_date)aa
    ...
    select user_id,event_date,count(distinct item_id) as user_distinct_act from
    (select distinct user_id,item_id,event_date from washed.tianchi_p_ten_buy_1_30
        where event_date between 26 and 30 or event_date between 15 and 23)a
    group by user_id,event_date
    )b
    where user_distinct_act=1 
    order by user_id,event_date
...
drop table if exists feature.train_ui_l28_h1_only_act;
create table feature.train_ui_l28_h1_only_act as
    ...
    (select distinct user_id,item_id,event_date from washed.tianchi_p_ten_buy_1_30
    where event_date between 26 and 30 or event_date between 1 and 23 
    order by user_id,event_date)aa
    ...
    select user_id,event_date,count(distinct item_id) as user_distinct_act from
    (select distinct user_id,item_id,event_date from washed.tianchi_p_ten_buy_1_30
        where event_date between 26 and 30 or event_date between 1 and 23)a
    group by user_id,event_date
    )b
    where user_distinct_act=1 
    order by user_id,event_date
