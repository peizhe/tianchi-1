...
create table feature.category_d12_buy as
    select category_id, ifnull(category_d12_buy,0) as category_d12_buy from
    (select category_id from washed.category_subset) as a
    left outer join
    (select item_category as category_id_b,(count(*)/2) as category_d12_buy from washed.tianchi_p_ten_1_30
    where event_date between 24 and 25 and behavior_type=4
    group by category_id_b) as b
    on category_id=category_id_b;

# 双12期间平均每天交互次数    
drop table if exists feature.category_d12_act;
create table feature.category_d12_act as
    select category_id, ifnull(category_d12_act,0) as category_d12_act from
    (select category_id from washed.category_subset) as a
    left outer join
    (select item_category as category_id_b,(count(*)/2) as category_d12_act from washed.tianchi_p_ten_1_30
...
create table feature.category_d12_ave_buy as
	select category_id,ifnull(category_d12_ave_buy,0) as category_d12_ave_buy from
    (select category_id from washed.category_subset) as a
    left outer join
    (select item_category, (count(*)/count(distinct(user_id))) as category_d12_ave_buy from washed.tianchi_p_ten_1_30
    where event_date between 24 and 25 and behavior_type=4
    group by item_category) as b
    on category_id=item_category;
    
# 双12期间人均交互次数
drop table if exists feature.category_d12_ave_act;
create table feature.category_d12_ave_act as
    select category_id,ifnull(category_d12_ave_act,0) as category_d12_ave_act from
    (select category_id from washed.category_subset) as a
    left outer join
    (select item_category, (count(*)/count(distinct(user_id))) as category_d12_ave_act from washed.tianchi_p_ten_1_30
    where event_date between 24 and 25
    group by item_category) as b
    on category_id=item_category;
...
create table feature.train_category_1_7_buy as
    select category_id,(sum/7) as category_1_7_buy
...
create table feature.train_category_1_7_ave_buy as
    select category_id, ifnull(category_1_7_buy/user,0) as category_1_7_ave_buy
    from (select category_id,category_1_7_buy from feature.train_category_1_7_buy) as a
    left outer join
...
create table feature.train_category_8_14_buy as
    select category_id,(sum/7) as category_8_14_buy
    from (select category_id from washed.category_subset) as a
    left outer join
    (select item_category as category_id_1, count(*) as sum from washed.tianchi_p_1_30
...
create table feature.train_category_8_14_ave_buy as
    select category_id, ifnull(category_8_14_buy/user,0) as category_8_14_ave_buy
    from (select category_id,category_8_14_buy from feature.train_category_8_14_buy) as a
    left outer join
    (select item_category as category_id_1,count(distinct(user_id)) as user from washed.tianchi_p_1_30
    where event_date between 8 and 14 and behavior_type=4 group by category_id_1) as b
    on a.category_id=b.category_id_1;
...
create table feature.train_category_15_21_buy as
    select category_id,(sum/7) as category_15_21_buy
    from (select category_id from washed.category_subset) as a
    left outer join
    (select item_category as category_id_1, count(*) as sum from washed.tianchi_p_1_30
...
create table feature.train_category_15_21_ave_buy as
    select category_id, ifnull(category_15_21_buy/user,0) as category_15_21_ave_buy
    from (select category_id,category_15_21_buy from feature.train_category_15_21_buy) as a
    left outer join
    (select item_category as category_id_1,count(distinct(user_id)) as user from washed.tianchi_p_1_30
    where event_date between 15 and 21 and behavior_type=4 group by category_id_1) as b
    on a.category_id=b.category_id_1;
...
create table feature.train_category_22_30_buy as
    select category_id,(sum/7) as category_22_30_buy
    from (select category_id from washed.category_subset) as a
    left outer join
    (select item_category as category_id_1, count(*) as sum from washed.tianchi_p_1_30
...
create table feature.train_category_22_30_ave_buy as
    select category_id, ifnull(category_22_30_buy/user,0) as category_22_30_ave_buy
    from (select category_id,category_22_30_buy from feature.train_category_22_30_buy) as a
    left outer join
    (select item_category as category_id_1,count(distinct(user_id)) as user from washed.tianchi_p_1_30
    where event_date in (22,23,26,27,28,29,30) and behavior_type=4 group by category_id_1) as b
    on a.category_id=b.category_id_1;
...
create table feature.pre_category_2_8_buy as
    select category_id,(sum/7) as category_2_8_buy
    from (select category_id from washed.category_subset) as a
    left outer join
...
create table feature.pre_category_2_8_ave_buy as
    select category_id, ifnull(category_2_8_buy/user,0) as category_2_8_ave_buy
    from (select category_id,category_2_8_buy from feature.pre_category_2_8_buy) as a
    left outer join
...
create table feature.pre_category_9_15_buy as
    select category_id,(sum/7) as category_9_15_buy
    from (select category_id from washed.category_subset) as a
    left outer join
    (select item_category as category_id_1, count(*) as sum from washed.tianchi_p_2_31
...
create table feature.pre_category_9_15_ave_buy as
    select category_id, ifnull(category_9_15_buy/user,0) as category_9_15_ave_buy
    from (select category_id,category_9_15_buy from feature.pre_category_9_15_buy) as a
    left outer join
    (select item_category as category_id_1,count(distinct(user_id)) as user from washed.tianchi_p_2_31
    where event_date between 9 and 15 and behavior_type=4 group by category_id_1) as b
    on a.category_id=b.category_id_1;
...
create table feature.pre_category_16_22_buy as
    select category_id,(sum/7) as category_16_22_buy
    from (select category_id from washed.category_subset) as a
    left outer join
    (select item_category as category_id_1, count(*) as sum from washed.tianchi_p_2_31
...
create table feature.pre_category_16_22_ave_buy as
    select category_id, ifnull(category_16_22_buy/user,0) as category_16_22_ave_buy
    from (select category_id,category_16_22_buy from feature.pre_category_16_22_buy) as a
    left outer join
    (select item_category as category_id_1,count(distinct(user_id)) as user from washed.tianchi_p_2_31
    where event_date between 16 and 22 and behavior_type=4 group by category_id_1) as b
    on a.category_id=b.category_id_1;
...
create table feature.pre_category_23_31_buy as
    select category_id,(sum/7) as category_23_31_buy
    from (select category_id from washed.category_subset) as a
    left outer join
    (select item_category as category_id_1, count(*) as sum from washed.tianchi_p_2_31
...
create table feature.pre_category_23_31_ave_buy as
    select category_id, ifnull(category_23_31_buy/user,0) as category_23_31_ave_buy
    from (select category_id,category_23_31_buy from feature.pre_category_23_31_buy) as a
    left outer join
    (select item_category as category_id_1,count(distinct(user_id)) as user from washed.tianchi_p_2_31
    where event_date in (23,26,27,28,29,30,31) and behavior_type=4 group by category_id_1) as b
    on a.category_id=b.category_id_1;