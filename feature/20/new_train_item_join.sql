...
(select item_id,item_l1_buy from new.train_item_l1_buy)a
left outer join
(select item_id as item_id_1,item_l3_buy from new.train_item_l3_buy)b
on(a.item_id=b.item_id_1))c
left outer join
(select item_id as item_id_1,item_l7_buy from new.train_item_l7_buy)d
on(c.item_id=d.item_id_1))e
left outer join
(select item_id as item_id_1,item_l14_buy from new.train_item_l14_buy)f
...
(select item_id,item_l1_clk from new.train_item_l1_clk)a
left outer join
(select item_id as item_id_1,item_l3_clk from new.train_item_l3_clk)b
on(a.item_id=b.item_id_1))c
left outer join
(select item_id as item_id_1,item_l7_clk from new.train_item_l7_clk)d
on(c.item_id=d.item_id_1))e
left outer join
(select item_id as item_id_1,item_l14_clk from new.train_item_l14_clk)f
on(e.item_id=f.item_id_1);
...
(select item_id,item_l1_distinct_clk from new.train_item_l1_distinct_clk)a
left outer join
(select item_id as item_id_1,item_l3_distinct_clk from new.train_item_l3_distinct_clk)b
on(a.item_id=b.item_id_1))c
left outer join
(select item_id as item_id_1,item_l7_distinct_clk from new.train_item_l7_distinct_clk)d
on(c.item_id=d.item_id_1))e
left outer join
(select item_id as item_id_1,item_l14_distinct_clk from new.train_item_l14_distinct_clk)f
on(e.item_id=f.item_id_1);
...
(select item_id,item_l1_distinct_buy from new.train_item_l1_distinct_buy)a
left outer join
(select item_id as item_id_1,item_l3_distinct_buy from new.train_item_l3_distinct_buy)b
on(a.item_id=b.item_id_1))c
left outer join
(select item_id as item_id_1,item_l7_distinct_buy from new.train_item_l7_distinct_buy)d
on(c.item_id=d.item_id_1))e
left outer join
(select item_id as item_id_1,item_l14_distinct_buy from new.train_item_l14_distinct_buy)f
on(e.item_id=f.item_id_1);
...
(select item_id,item_l_buy_date from new.train_item_l_buy_date)a
left outer join
(select item_id as item_id_1,item_l_act_date from new.train_item_l_act_date)b
on(a.item_id=b.item_id_1))c
left outer join
(select item_id as item_id_1,item_ifrebuy from new.train_item_ifrebuy)d
on(c.item_id=d.item_id_1))e
left outer join
(select item_id as item_id_1,item_distinct_rebuy from new.train_item_distinct_rebuy)f
on(e.item_id=f.item_id_1);



drop table if exists newresult.train_item;
create table newresult.train_item as 
...
drop table if exists newresult.train_ui_user_item;
create table newresult.train_ui_user_item as 
