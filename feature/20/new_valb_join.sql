...
(select user_id,item_id,ui_l1_buy from new.valb_ui_l1_buy)a
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l2_buy from new.valb_ui_l2_buy)b
on(a.user_id=b.user_id_1 and a.item_id=b.item_id_1))c
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l3_buy from new.valb_ui_l3_buy)d
on(c.user_id=d.user_id_1 and c.item_id=d.item_id_1))e
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l5_buy from new.valb_ui_l5_buy)f
on(e.user_id=f.user_id_1 and e.item_id=f.item_id_1))g
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l7_buy from new.valb_ui_l7_buy)h
...
(select user_id,item_id,ui_l1_clk from new.valb_ui_l1_clk)a
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l2_clk from new.valb_ui_l2_clk)b
on(a.user_id=b.user_id_1 and a.item_id=b.item_id_1))c
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l3_clk from new.valb_ui_l3_clk)d
on(c.user_id=d.user_id_1 and c.item_id=d.item_id_1))e
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l5_clk from new.valb_ui_l5_clk)f
on(e.user_id=f.user_id_1 and e.item_id=f.item_id_1))g
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l7_clk from new.valb_ui_l7_clk)h
on(g.user_id=h.user_id_1 and g.item_id=h.item_id_1);
...
(select user_id,item_id,ui_l10_buy from new.valb_ui_l10_buy)a
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l14_buy from new.valb_ui_l14_buy)b
on(a.user_id=b.user_id_1 and a.item_id=b.item_id_1))c
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l18_buy from new.valb_ui_l18_buy)d
...
(select user_id,item_id,ui_l10_clk from new.valb_ui_l10_clk)a
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l14_clk from new.valb_ui_l14_clk)b
on(a.user_id=b.user_id_1 and a.item_id=b.item_id_1))c
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l18_clk from new.valb_ui_l18_clk)d
on(c.user_id=d.user_id_1 and c.item_id=d.item_id_1);
...
(select user_id,item_id,ui_d12_buy from new.valb_ui_d12_buy)a
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_d12_clk from new.valb_ui_d12_clk)b
on(a.user_id=b.user_id_1 and a.item_id=b.item_id_1);
...
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_fl_buy_distance from new.valb_ui_fl_buy_distance)b
on(a.user_id=b.user_id_1 and a.item_id=b.item_id_1))c
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l_actday_clk from new.valb_ui_l_actday_clk)d
on(c.user_id=d.user_id_1 and c.item_id=d.item_id_1))e
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l_actday_favor from new.valb_ui_l_actday_favor)f
on(e.user_id=f.user_id_1 and e.item_id=f.item_id_1))g
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l_actday_buy from new.valb_ui_l_actday_buy)h
on(g.user_id=h.user_id_1 and g.item_id=h.item_id_1))i
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l_act_date from new.valb_ui_l_act_date)j
...
(select user_id,item_id,ui_l3_h1_buy from new.valb_ui_l3_h1_buy)a
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l5_h1_buy from new.valb_ui_l5_h1_buy)b
on(a.user_id=b.user_id_1 and a.item_id=b.item_id_1))c
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l7_h1_buy from new.valb_ui_l7_h1_buy)d
on(c.user_id=d.user_id_1 and c.item_id=d.item_id_1))e
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l3_h1_act from new.valb_ui_l3_h1_act)f
on(e.user_id=f.user_id_1 and e.item_id=f.item_id_1))g
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l5_h1_act from new.valb_ui_l5_h1_act)h
on(g.user_id=h.user_id_1 and g.item_id=h.item_id_1))i
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l7_h1_act from new.valb_ui_l7_h1_act)j
on(i.user_id=j.user_id_1 and i.item_id=j.item_id_1);
...
(select user_id,item_id,ui_f_buybefore_clk from new.valb_ui_f_buybefore_clk)a
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_f_buybefore_favor from new.valb_ui_f_buybefore_favor)b
on(a.user_id=b.user_id_1 and a.item_id=b.item_id_1))c
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_f_buybefore_cart from new.valb_ui_f_buybefore_cart)d
on(c.user_id=d.user_id_1 and c.item_id=d.item_id_1);
...
(select user_id,item_id,ui_l7_clk2buy from new.valb_ui_l7_clk2buy)a
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l14_clk2buy from new.valb_ui_l14_clk2buy)b
on(a.user_id=b.user_id_1 and a.item_id=b.item_id_1))c
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l3_clk2buy from new.valb_ui_l3_clk2buy)d
on(c.user_id=d.user_id_1 and c.item_id=d.item_id_1))e
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l7_later2buy from new.valb_ui_l7_later2buy)f
on(e.user_id=f.user_id_1 and e.item_id=f.item_id_1))g
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l14_later2buy from new.valb_ui_l14_later2buy)h
on(g.user_id=h.user_id_1 and g.item_id=h.item_id_1))i
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l3_later2buy from new.valb_ui_l3_later2buy)j
on(i.user_id=j.user_id_1 and i.item_id=j.item_id_1);
...
(select user_id,item_id,ui_l_act_distance from new.valb_ui_l_act_distance)a
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_min_distance,ui_avg_distance,ui_max_distance from new.valb_ui_distance)b
on(a.user_id=b.user_id_1 and a.item_id=b.item_id_1);
...
(select user_id,item_id,ui_l1_cart from new.valb_ui_l1_cart)a
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l2_cart from new.valb_ui_l2_cart)b
on(a.user_id=b.user_id_1 and a.item_id=b.item_id_1))c
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l3_cart from new.valb_ui_l3_cart)d
on(c.user_id=d.user_id_1 and c.item_id=d.item_id_1))e
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l7_cart from new.valb_ui_l7_cart)f
on(e.user_id=f.user_id_1 and e.item_id=f.item_id_1))g
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l7_favor from new.valb_ui_l7_favor)h
on(g.user_id=h.user_id_1 and g.item_id=h.item_id_1))i
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l14_favor from new.valb_ui_l14_favor)j
on(i.user_id=j.user_id_1 and i.item_id=j.item_id_1);
...
(select user_id,item_id,ui_l18_favor from new.valb_ui_l18_favor)a
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l_actnextday_other_distinct_act from new.valb_ui_l_actnextday_other_distinct_act)b
on(a.user_id=b.user_id_1 and a.item_id=b.item_id_1))c
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l1_h1_only_act from new.valb_ui_l1_h1_only_act)d
on(c.user_id=d.user_id_1 and c.item_id=d.item_id_1))e
left outer join
(select user_id as user_id_1,item_id as item_id_1,ui_l3_h1_only_act from new.valb_ui_l3_h1_only_act)f
...
drop table if exists newresult.valb_ui;
create table newresult.valb_ui as 
...
(select user_id,user_l1_clk from new.valb_user_l1_clk)a
left outer join
(select user_id as user_id_1,user_l3_clk from new.valb_user_l3_clk)b
on(a.user_id=b.user_id_1))c
left outer join
(select user_id as user_id_1,user_l7_clk from new.valb_user_l7_clk)d
on(c.user_id=d.user_id_1))e
left outer join
(select user_id as user_id_1,user_l10_clk from new.valb_user_l10_clk)f
on(e.user_id=f.user_id_1))g
left outer join
(select user_id as user_id_1,user_l14_clk from new.valb_user_l14_clk)h
on(g.user_id=h.user_id_1))i
left outer join
(select user_id as user_id_1,user_l18_clk from new.valb_user_l18_clk)j
...
(select user_id,user_l1_buy from new.valb_user_l1_buy)a
left outer join
(select user_id as user_id_1,user_l3_buy from new.valb_user_l3_buy)b
on(a.user_id=b.user_id_1))c
left outer join
(select user_id as user_id_1,user_l7_buy from new.valb_user_l7_buy)d
on(c.user_id=d.user_id_1))e
left outer join
(select user_id as user_id_1,user_l10_buy from new.valb_user_l10_buy)f
on(e.user_id=f.user_id_1))g
left outer join
(select user_id as user_id_1,user_l14_buy from new.valb_user_l14_buy)h
on(g.user_id=h.user_id_1))i
left outer join
(select user_id as user_id_1,user_l18_buy from new.valb_user_l18_buy)j
on(i.user_id=j.user_id_1);
...
(select user_id,user_d12_clk from new.valb_user_d12_clk)a
left outer join
(select user_id as user_id_1,user_d12_buy from new.valb_user_d12_buy)b
on(a.user_id=b.user_id_1))c
left outer join
(select user_id as user_id_1,user_l_act_date from new.valb_user_l_act_date)d
on(c.user_id=d.user_id_1))e
left outer join
(select user_id as user_id_1,user_l_buy_date from new.valb_user_l_buy_date)f
...
(select user_id,user_l7_clk2buy from new.valb_user_l7_clk2buy)a
left outer join
(select user_id as user_id_1,user_l14_clk2buy from new.valb_user_l14_clk2buy)b
on(a.user_id=b.user_id_1))c
left outer join
(select user_id as user_id_1,user_l3_clk2buy from new.valb_user_l3_clk2buy)d
on(c.user_id=d.user_id_1))e
left outer join
(select user_id as user_id_1,user_l7_later2buy from new.valb_user_l7_later2buy)f
on(e.user_id=f.user_id_1))g
left outer join
(select user_id as user_id_1,user_l14_later2buy from new.valb_user_l14_later2buy)h
on(g.user_id=h.user_id_1))i
left outer join
(select user_id as user_id_1,user_l3_later2buy from new.valb_user_l3_later2buy)j
on(i.user_id=j.user_id_1);
...
(select user_id,user_l7_h1_buy from new.valb_user_l7_h1_buy)a
left outer join
(select user_id as user_id_1,user_l14_h1_buy from new.valb_user_l14_h1_buy)b
on(a.user_id=b.user_id_1))c
left outer join
(select user_id as user_id_1,user_l3_h1_buy from new.valb_user_l3_h1_buy)d
...
(select user_id,user_l1_cart from new.valb_user_l1_cart)a
left outer join
(select user_id as user_id_1,user_l3_cart from new.valb_user_l3_cart)b
on(a.user_id=b.user_id_1))c
left outer join
(select user_id as user_id_1,user_l7_cart from new.valb_user_l7_cart)d
on(c.user_id=d.user_id_1))e
left outer join
(select user_id as user_id_1,user_l7_favor from new.valb_user_l7_favor)f
on(e.user_id=f.user_id_1))g
left outer join
(select user_id as user_id_1,user_l10_favor from new.valb_user_l10_favor)h
on(g.user_id=h.user_id_1))i
left outer join
(select user_id as user_id_1,user_l14_favor from new.valb_user_l14_favor)j
on(i.user_id=j.user_id_1);
...
(select user_id,user_l1_distinct_clk from new.valb_user_l1_distinct_clk)a
left outer join
(select user_id as user_id_1,user_l3_distinct_clk from new.valb_user_l3_distinct_clk)b
on(a.user_id=b.user_id_1))c
left outer join
(select user_id as user_id_1,user_l7_distinct_clk from new.valb_user_l7_distinct_clk)d
on(c.user_id=d.user_id_1))e
left outer join
(select user_id as user_id_1,user_l1_distinct_buy from new.valb_user_l1_distinct_buy)f
on(e.user_id=f.user_id_1))g
left outer join
(select user_id as user_id_1,user_l3_distinct_buy from new.valb_user_l3_distinct_buy)h
on(g.user_id=h.user_id_1))i
left outer join
(select user_id as user_id_1,user_l7_distinct_buy from new.valb_user_l7_distinct_buy)j
on(i.user_id=j.user_id_1);
...
drop table if exists newresult.valb_user;
create table newresult.valb_user as 
...
drop table if exists newresult.valb_ui_user;
create table newresult.valb_ui_user as 
