...
if __name__ == "__main__":
    ...
    ####################################################
    training_data=fetch_data(cur,'train_90_1_10')
    ...
    # #Random Forest
    rand_forest_param={"n_estimators":500, "min_samples_leaf":100, "n_jobs":-1}
    model_rand_forest=RandomForestClassifier(**rand_forest_param)
    ...
    # joblib.dump(testing_result_rf_class,'rf_class.model_new_test')


    # #GBRT
    # GBRT_param={"max_depth":,"n_estimators":,"learning_rate":}
    #######################################################
    #model_GBRT=GradientBoostingClassifier(n_estimators=200,max_depth=3,min_samples_leaf=1000)
    #######################################################
