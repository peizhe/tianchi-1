...
def fetch_data(cur,feature_table_name,table_schema='tianchi',
    except_fields=[('id',),('user_id',),('item_id',)]):
    '''
...
if __name__ == "__main__":
    ...
    training_data=fetch_data(cur,'user')
    training_groundtruth=fetch_data(cur,'user')
    testing_data=fetch_data(cur,'user')
